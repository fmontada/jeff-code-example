...
inputs = {
  ...
  default_from_address = "Omaze <weloveyou@omazeaccounts.com>"
  email_from_address   = "Omaze <weloveyou@omazeaccounts.com>"
  tenant_name          = "Omaze - CoreLoop PRD"
  ...
  omaze_web_domain = "https://dogfood.omaze.com"
  ...
  email_templates = {
    "reset_email" = {
      ...
      result_url           = "https://dogfood.omaze.com"
    ...
    "verify_email" = {
      ...
      result_url           = "{% if application.name == 'Omaze%20Mobile' %} {{ application.callback_domain }} {% else %} https://dogfood.omaze.com {% endif %}"
      url_lifetime_seconds = 604800
      enabled              = true
    },
    "blocked_account" = {
