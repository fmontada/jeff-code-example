...
inputs = {
  ...
  default_from_address = "Omaze - STG <weloveyou@stg-omazeaccounts.com>"
  email_from_address   = "Omaze - STG <weloveyou@stg-omazeaccounts.com>"
  tenant_name          = "Omaze - CoreLoop STG"
  ...
  omaze_web_domain = "https://dogfood.stg.omazedev.com"
  ...
  email_templates = {
    "reset_email" = {
      ...
      result_url           = "https://dogfood.stg.omazedev.com"
    ...
    "verify_email" = {
      ...
      result_url           = "{% if application.name == 'Omaze%20Mobile' %} {{ application.callback_domain }} {% else %} https://dogfood.stg.omazedev.com {% endif %}"
      url_lifetime_seconds = 604800
      enabled              = true
    },
    "blocked_account" = {
  ...
  "web_clients" = {
    "Omaze Web" = {
      ...
      callbacks = [
        "http://localhost:3000",
        "https://dogfood.stg.omazedev.com",
        "https://dogfood.omaze.com",
        "http://localhost:3000/account",
        "https://dogfood.stg.omazedev.com/account",
